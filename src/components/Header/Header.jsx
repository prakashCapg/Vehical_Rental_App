...
import { Userlogout } from "../../services/User-login.service";
  ...
  return (
    <div>
      <div className="bg-slate-100 sticky top-0 z-50 mx-auto flex w-full  items-center h-12 shadow-md">
        <Menu
          className="sm:hidden h-10 w-16 cursor-pointer mr-4"
          onClick={() => setMenuOpen(!menuOpen)}
        />
        <img
          src={logo}
          className="logo w-16 h-10 rounded-xl ml-auto sm:ml-4"
          alt="Logo"
        />
          ...
          <div className="bg-white p-4 w-64 h-64 shadow-lg absolute top-12 right-4">
            <ul className="flex flex-col items-center">
              ...
              <div className="w-full ">
                ...
                <button
                  className="bg-white  mt-2 hover:bg-red-300"
      ...
      {menuOpen && (
        <div className="sm:hidden fixed top-0 left-0 w-2/3 h-full bg-white shadow-lg z-50 p-4">
          ...
          <ul className="pt-2 mt-2" onClick={() => setMenuOpen(false)}>
            ...
            <li>
              <button
                className="bg-white border-red-400 p-1 rounded-lg mt-2 hover:bg-red-300"
                onClick={handleSignout}
              >
                Sign Out
              </button>
